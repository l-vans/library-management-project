...
//            contentPane.add(l5);
            ...
            JLabel l6 = new JLabel("Developed By : Luke Evans");
            l6.setFont(new Font("Trebuchet MS", Font.BOLD, 30));
            l6.setBounds(70, 198, 600, 35);
            contentPane.add(l6);

            JLabel l7 = new JLabel("Contact Me : contact@lvansdev.com");
...
//
//
            JLabel l10 = new JLabel("**Inspired by Code for Interview on YouTube and Instagram**");
